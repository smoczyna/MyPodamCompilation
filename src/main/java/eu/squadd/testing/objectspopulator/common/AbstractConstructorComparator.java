 ...
 * <p>
 * The priority goes to constructors with the {@link ScannerConstructor}
...
public abstract class AbstractConstructorComparator implements Comparator<Constructor<?>> {
    ...
    public int compareAnnotations(Constructor<?> constructor1, Constructor<?> constructor2) {
        ...
        boolean choose1 = constructor1.getAnnotation(ScannerConstructor.class) != null;
        boolean choose2 = constructor2.getAnnotation(ScannerConstructor.class) != null;
        if (choose1 && !choose2) {
