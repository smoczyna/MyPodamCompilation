...
import eu.squadd.testing.objectspopulator.common.ConstructorHeavyFirstComparator;
import eu.squadd.testing.objectspopulator.common.AttributeStrategy;
import eu.squadd.testing.objectspopulator.common.MethodHeavyFirstComparator;
import eu.squadd.testing.objectspopulator.common.AbstractMethodComparator;
import eu.squadd.testing.objectspopulator.common.MethodLightFirstComparator;
import eu.squadd.testing.objectspopulator.common.ConstructorLightFirstComparator;
...
import eu.squadd.testing.objectspopulator.typeManufacturers.ArrayTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.BooleanTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.ByteTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.CharTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.CollectionTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.DoubleTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.EnumTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.FloatTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.GenericTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.IntTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.LongTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.MapTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.ShortTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.StringTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.TypeManufacturer;
...
import eu.squadd.testing.objectspopulator.typeManufacturers.BigDecimalTypeManufacturerImpl;
import eu.squadd.testing.objectspopulator.typeManufacturers.BigIntegerTypeManufacturerImpl;
...
public abstract class AbstractRandomDataProviderStrategy implements RandomDataProviderStrategy {
    ...
    /**
     * A list of user-submitted factories to build interfaces and abstract
     * classes
     */
    ...
    public AbstractRandomDataProviderStrategy() {
        this(ScannerConstants.DEFAULT_NBR_COLLECTION_ELEMENTS);
    }
     ...
     *
     * @param constructors Array of POJO's constructors
     * @param order {@link uk.co.jemos.podam.api.DataProviderStrategy.Order} how
     ...
     * POJO. Default strategy consist of putting methods with more parameters to
     * be tried first.
     *
     * @param methods Array of POJO's methods
     * @param order {@link uk.co.jemos.podam.api.DataProviderStrategy.Order} how
     * to sort constructors
     */
    @Override
     ...
     * the old value will not be replaced by the new value. If you want to force
     * the value replacement, invoke removeSpecific before invoking this method.
     * If you want to implement more sophisticated binding strategy, override
     * this class.
     *
     * @param <T> return type
