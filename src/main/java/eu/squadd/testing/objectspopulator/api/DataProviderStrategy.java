...
public interface DataProviderStrategy {
     ...
     * @param type the specific class type the specified manufacturer will
     * instantiate.
     * @param typeManufacturer type manufacturer implementation to be registered
     * @return itself
     */
    ...
    /**
     * Remove binding of a class type to a specific implementation of type
     * manufacturer
     *
     * @param <T> type of objects to be produced by the manufacturer
     * @param type the specific class type to remove binding
     * @return itself
     */
     ...
     * the old value will be replaced by the new value. If you want to implement
     ...
     * </p>
     *
     * @param type Type of collection's elements
     ...
     *
     * @param newNumberOfCollectionElements The new number of collection
     * elements.
     */
    public void setDefaultNumberOfCollectionElements(int newNumberOfCollectionElements);

    /**
     * Returns how many times it is allowed to PODAM to create an instance of
     * the same class in a recursive hierarchy
     * <p>
     * Implementations of this interface need to provide this value.
     * </p>
     *
     * @param type Type of POJO to be created
     * @return How many times it is allowed to create an instance of the same
     ...
     * <p>
     * Should return factory class type, which can be used to instantiate an
     * abstract class type or interface.
     * </p>
     *
     * @param nonInstantiatableClass Abstract class type or interface
     ...
     * </p>
     *
     * @param <T> The type of class being resolved
     * @param nonInstantiatableClass Abstract class type or interface
     ...
     * <p>
     * Searches for mapping between annotations and attribute strategies, which
     * will be used then for populating fields or constructor parameters.
     * </p>
     *
     * @param annotationClass Annotation class to inspect
