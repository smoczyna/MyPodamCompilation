...
import eu.squadd.testing.objectspopulator.common.ScannerExclude;
...
public abstract class AbstractClassInfoStrategy implements ClassInfoStrategy,
    ...
    // ------------------->> Public methods
    /**
     * Adds the specified {@link Annotation} to set of excluded annotations, if
     * it is not already present.
     *
     * @param annotation the annotation to use as an exclusion mark
     * @return itself
     */
     ...
     * @return this object
     * @throws SecurityException If a security exception occurred while
     * retrieving the method
     * @throws NoSuchMethodException If pojoClass doesn't declare the required
     * method
     * @since 5.3.0
     */
    ...
    /**
     * Removes the specified {@link Annotation} from set of excluded
     * annotations.
     *
     * @param annotation the annotation used as an exclusion mark
     * @return itself
     */
    ...
    /**
     * Adds the specified field to set of excluded fields, if it is not already
     * present.
     *
     * @param pojoClass a class for which fields should be skipped
     * @param fieldName the field name to use as an exclusion mark
     * @return itself
     */
     ...
     *
     * @param pojoClass a class for which fields should be skipped
     * @param fieldName the field name used as an exlusion mark
     * @return itself
     */
     ...
     * @param excludeFieldAnnotations the fields marked with any of these
     * annotations will not be included in the class info
     * @param excludedFields the fields matching the given names will not be
     * included in the class info
     * @param attributeApprover a {@link ClassAttributeApprover} implementation,
     * which defines which attributes to skip and which to process
     * @param extraMethods extra methods to call after object initialization
     ...
     * @param annotations the set of annotations to look for in the field
     ...
     *
     * @param clazz The class to analyze for setters
     * @param attributeMap The {@link Map} which will be filled with class'
     * attributes
     * @param excludeAnnotations The {@link Set} containing annotations marking
     * fields to be excluded
     * @param excludedFields The {@link Set} containing field names to be
     * excluded
     */
    protected void findPojoAttributes(Class<?> clazz,
        ...
        excludeAnnotations.add(ScannerExclude.class);
     ...
     * return value depends on the adherence to JavaBean standards.
     * </p>
     *
     * @param methodName The accessor method from which the field name is
     * required
     * @param pattern The pattern to strip from the method name
