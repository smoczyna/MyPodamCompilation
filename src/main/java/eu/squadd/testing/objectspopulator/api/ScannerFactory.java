...
public interface ScannerFactory {
     ...
     * values is required
     * @param genericTypeArgs The generic Type arguments for a generic class
     * instance
    ...
    /**
     * Generic method which populates an instance of the given class with dummy
     * values, using the default data provider strategy.
     *
     * <p>
     * This method uses {@link RandomDataProviderStrategyImpl} as the default
     * implementation.
     ...
     *
     * @param strategy A data provider strategy to be used by this factory
     * @return instance of the factory for chaining
     */
    ScannerFactory setStrategy(DataProviderStrategy strategy);
     ...
     * @return the strategy
     */
    ScannerFactory getExternalFactory();

    /**
     * Sets an external factory for this factory to delegate requests it cannot
     * process
     *
     * @param externalFactory An external factory to be used by this factory
     * @return instance of this factory for chaining
     */
    ScannerFactory setExternalFactory(ScannerFactory externalFactory);
     ...
     *
     * @param classInfoStrategy A class info strategy to be used by this factory
     * @return instance of the factory for chaining
     */
