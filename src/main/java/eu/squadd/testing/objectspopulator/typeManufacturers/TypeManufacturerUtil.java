...
import eu.squadd.testing.objectspopulator.common.BeanValidationStrategy;
...
import eu.squadd.testing.objectspopulator.common.ScannerStrategyValue;
...
public final class TypeManufacturerUtil {
    ...
    public static AttributeStrategy<?> findAttributeStrategy(DataProviderStrategy strategy,
        ...
        while (iter.hasNext()) {
            ...
            if (annotation instanceof ScannerStrategyValue) {
                ScannerStrategyValue strategyAnnotation = (ScannerStrategyValue) annotation;
    ...
    public static Type[] fillTypeArgMap(final Map<String, Type> typeArgsMap,
        ...
        if (genericTypes.size() > 0) {
            ...
            genericTypeArgsExtra = ScannerConstants.NO_TYPES;
        }
    ...
    public static Integer findCollectionSize(DataProviderStrategy strategy,
        ...
        for (Annotation annotation : annotations) {
            if (annotation instanceof ScannerCollection) {

                ScannerCollection collectionAnnotation = (ScannerCollection) annotation;
    ...
    public static Class<?> resolveGenericParameter(Type paramType,
        ...
        methodGenericTypeArgs.set(ScannerConstants.NO_TYPES);
     ...
     * @return The value for the {@link ScannerStrategyValue} annotation with
     * which the attribute was annotated
     * @throws IllegalArgumentException If the type of the data strategy defined
     * for the {@link ScannerStrategyValue} annotation is not assignable to the
    ...
    public static Object returnAttributeDataStrategyValue(Class<?> attributeType,
        ...
        if (retValue != null) {
            Class<?> desiredType = attributeType.isPrimitive()
                    ? ScannerUtils.primitiveToBoxedType(attributeType) : attributeType;
