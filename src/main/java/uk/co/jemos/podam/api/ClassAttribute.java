...
/**
 * This class wraps fields, getters and setters information of the same
 * attribute
 * <p>
 * The purpose of this class is to carry information about single attribute of
 * POJO class.
 * </p>
 *
 * @author daivanov
...
public class ClassAttribute implements Serializable {
     ...
     * Full constructor
     *
     * @param name attribute's name, must be filled
     * @param attribute attribute, can be null
     * @param getters The set of getters for this attributes
     * @param setters The set of setters for this attributes
     */
