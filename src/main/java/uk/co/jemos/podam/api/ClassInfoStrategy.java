...
public interface ClassInfoStrategy {
     ...
     * </p>
     *
     * @return set of annotations, which mark fields to be skipped from
     * populating.
     */
     ...
     * <p>
     * Should return set of field names as case-sensitive string, which will be
     * treated as notion for {@link PodamFactory} to skip production of these
     * particular fields.
     * </p>
     *
     * @param pojoClass a class for which fields should be skipped
     * @return set of field name, which mark fields to be skipped from
     * populating.
     */
    ...
    /**
     *
     * @param pojoClass a class to introspect and fetch attributes
